...
def test_priority1_bank_auto_applies():
    ...
    """Verify the priority1 bank auto applies scenario."""
...
def test_priority1_bank_with_suffix_auto_applies():
    """Verify the priority1 bank with suffix auto applies scenario."""
...
def test_non_target_high_score_is_draft_not_auto():
    ...
    """Verify the non target high score is draft not auto scenario."""
...
def test_none_score():
    """Verify the none score scenario."""
...
def _gh_job(score: float | None, company: str = "Stripe") -> Job:
    """Provide a test helper for gh job."""
...
def test_greenhouse_tiered_normally_not_special_cased():
    ...
    """Verify the greenhouse tiered normally not special cased scenario."""
